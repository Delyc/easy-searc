...
const Hero = () => {
    return ( 
        <SectionWrapper>
        <section className='relative flex flex-col gap-10 xl:flex xl:flex-row xl:justify-between items-center mt-48 lg:mt-44'>
            ...
            <div className="relative w-4/5 h-[30vh] xl:w-1/2 bg-red-500 flex items-center xl:h-[70vh]">
